...
var ADMIN_USERNAME = process.env.ADMIN_USERNAME || "kjoshi2064@gmail.com";
var ADMIN_PASSWORD_RAW = process.env.ADMIN_PASSWORD || "kishor99farewell";
var ADMIN_PASSWORD_HASH = import_bcryptjs.default.hashSync(ADMIN_PASSWORD_RAW, 10);
...
app.post("/api/admin/login", (req, res) => {
  ...
  const isMatchUsername = inputUsername === ADMIN_USERNAME.toLowerCase() || inputUsername === "admin" || inputUsername === "admin@school.com" || inputUsername === "kjoshi2064@gmail.com";
  if (!isMatchUsername || !import_bcryptjs.default.compareSync(password, ADMIN_PASSWORD_HASH)) {
